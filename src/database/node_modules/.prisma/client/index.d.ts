...
export namespace Prisma {
  ...
  */
  ...
  type GetUserModelGroupByPayload<T extends UserModelGroupByArgs> = Promise<
    Array<
  ...
  export type UserModelGetPayload<
    ...
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]: P extends keyof UserModel ?UserModel [P]
  : 
     never
  } 
    : UserModel
  ...
  export interface UserModelDelegate<GlobalRejectSettings> {
    ...
    **/
    ...
    >(args: SubsetIntersection<T, UserModelGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetUserModelGroupByPayload<T> : Promise<InputErrors>
  }
  ...
  export type UserModelFindUniqueArgs = {
    ...
    **/
    ...
    /**
     * Throw an Error if a UserModel can't be found
     * 
    **/
